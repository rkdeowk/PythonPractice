...
from PythonPractice.EC.src.data_processor.strategy.strategy_max import MaxProcessingStrategy
from PythonPractice.EC.src.data_processor.strategy.strategy_min import MinProcessingStrategy
